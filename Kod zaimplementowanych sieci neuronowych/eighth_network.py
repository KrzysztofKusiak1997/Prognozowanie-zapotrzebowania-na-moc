...
def eighth_network(): 
    ...
    model = Sequential()
    model.add(Dense(512, input_dim=347, activation="linear"))
    ...
    #zapisanie modelu sieci wraz z wagami
    model.save("D:\\Studia\\Energetyka\\Praca_inzynierska\\siec_neuronowa\\eighth_model.h5")